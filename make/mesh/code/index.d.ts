...
import type { MeshLoad } from '../../index.js';
...
export declare function loadMintFile(deck: RiffDeck): any;
export declare function load_codeCard(base: Base, link: string): void;
export declare function load_codeCard_nestedChildren(load: MeshLoad): void;
export declare function load_codeCard_nestedChildren_term(load: MeshLoad): void;
