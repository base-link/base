...
export type MeshBindingCountdownType = {
  dependencies: Array<string>
  hook: MeshCallbackType
}

export type MeshCallbackType = () => void

export type MeshCardCode = {
...
export type MeshContainerScopeType = {
  declarations: Record<string, MeshVariableDeclarationType>
  parent?: MeshContainerScopeType
  steps: Array<MeshStepScopeType>
}

export type MeshDependencyObserverParentType = {
  observer: MeshLinkLook
  remaining: number
}

export type MeshFormLook = {
  hook?: MeshLookHook
  note: Array<MeshNote>
  properties?: MeshFormLookLinkList
}

export type MeshFormLookLinkList = {
  [name: string]: MeshFormLook
}

export type MeshLinkLook = {
  children: Array<MeshLinkLook | string>
  node: LinkNodeType
  parent?: MeshDependencyObserverParentType
  path: Array<string>
}

export type MeshLookHook = (value: unknown) => void

export type MeshLookLink = {
  base?: MeshLookLink
  find: boolean
  form: 'site-look-link'
  // counted
  hashLink?: MeshLookLinkList
  // dynamic properties
  hook?: MeshLookHook
  // pending
  link?: MeshLookLinkList
  name: string
...
export type MeshLookLinkList = {
  form: 'site-look-link-list'
  link: {
    [name: string]: MeshLookLink
  }
}
...
export const SITE_OBSERVER_STATE = [
  MeshNote.Initialized,
  MeshNote.StaticComplete,
  MeshNote.RuntimeComplete,
]
