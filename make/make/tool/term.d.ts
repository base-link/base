...
export declare function process_dynamicTerm(input: SiteProcessInputType): void;
export declare function process_first_dynamicTerm(input: SiteProcessInputType, property: string): void;
export declare function process_first_staticTerm(input: SiteProcessInputType, property: string): void;
