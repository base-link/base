import {
  Color,
  GreenBindType,
  GreenBooleanLinkType,
  GreenBooleanType,
  GreenCallbackType,
  GreenClassInputType,
  GreenClassInterfaceImplementationType,
  GreenClassInterfaceType,
  ...
  GreenExportType,
  GreenFunctionType,
  GreenHideExportVariableType,
  GreenImportType,
  GreenImportVariableRenameType,
  GreenImportVariableType,
  GreenInputType,
  GreenNativeClassInterfaceType,
  GreenPackageLicenseType,
  GreenPackageType,
  GreenPackageUserType,
  GreenPathLinkType,
  GreenStepType,
  GreenTemplateType,
  GreenTermLinkType,
...
export type YellowCodeModuleType = SiteModuleBaseType &
  YellowBaseType & {
    callbacks: Array<GreenCallbackType>
...
export type YellowPackageModuleType = SiteModuleBaseType &
  YellowBaseType & {
...
export type YellowPathLinkType =
  | YellowPathType
  | YellowStringArrayType
  | YellowTermType
  | YellowStringType
