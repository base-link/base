...
export function handle_codeCard(base, link) {
...
export function process_codeCard(base, link) {
    ...
    if (module.text.trim()) {
        module.linkTree.nest.forEach((nest, index) => {
            code.addTask(base, () => {
                code.process_codeCard_nestedChildren(code.withLink(colorInput, nest, index));
            });
        });
    }
}
export function process_codeCard_nestedChildren(input) {
...
export function process_codeCard_nestedChildren_term(input) {
