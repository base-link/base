...
export function process_codeCard_task(input, property = 'functions') {
    ...
    code.assumeNest(colorInput).forEach((nest, index) => {
        code.addTask(input.base, () => {
            code.process_codeCard_task_nestedChildren(code.withLink(colorInput, nest, index));
        });
    });
}
export function process_codeCard_task_nestedChildren(input) {
