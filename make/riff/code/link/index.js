...
export function process_codeCard_link(input, property = 'inputs') {
    ...
    code.assumeNest(colorInput).forEach((nest, index) => {
        code.addTask(input.base, () => {
            code.process_codeCard_link_nestedChildren(code.withLink(colorInput, nest, index));
        });
    });
}
export function process_codeCard_link_base(input) { }
export function process_codeCard_link_nestedChildren(input) {
