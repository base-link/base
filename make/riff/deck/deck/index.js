...
export function process_deckCard_deck(input) {
    ...
    code.assumeNest(input).forEach((nest, index) => {
        code.addTask(input.base, () => {
            code.process_deckCard_deck_nestedChildren(code.withLink(colorInput, nest, index));
        });
    });
}
export function process_deckCard_deck_nestedChildren(input) {
...
export function process_deckCard_deck_nestedTerm(input) {
