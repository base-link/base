...
Star idioms are standard ways of doing common programming things.
Here we show how to write Star for common situations.
...
In Star, strings are called "text". They are typically wrapped when
