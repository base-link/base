...
```
https://base.link/@textsurf/base/head/deck.link
https://base.link/@textsurf/base/1.2.3/deck.link
```
...
```
deck.base.link/@textsurf/base/1.2.3/base.tar.gz
deck.base.link/@textsurf/base/1.2.3/base.link
```
...
reaching out to support at meet@text.surf.
...
```
https://base.link/@textsurf/base/1.2.3
```
...
```
base.link/@textsurf/:deck/code/:file+
base.link/@textsurf/buck-1212 (4 letter word followed by numbers)
base.link/@textsurf/buck-1212/mark/:mark/code/:file+ (just the code)
base.link/@textsurf/buck-1212/mark/:mark/hint/:file+/task/create-something
```
...
make.base.link/@textsurf/buck-1234
  Shows the rendering
make.base.link/@textsurf/buck-1234/hint/:file+
make.base.link/@textsurf/buck-1234/code/:file+
make.base.link
  Try and share code
...
- loading from ./code loads ./link/textsurf/crow
- loading from ./link/textsurf/crow loads from
  - /link/.tree/textsurf/crow/1.0.23
- that gets compiled into
  - /link/.work/node_modules/textsurf/crow/index.js
- and that is actually a symlink to
  - /link/.work/node_modules/.tree/textsurf+crow@1.0.23/node_modules/textsurf/crow/index.js
              ...
              /node_modules
                /@textsurf
                  /crow
                    ...
                    /index.js.map
                      => ../../../../../../../tree/textsurf/crow/1.0.23
                  /wolf
                    /index.js
          /textsurf
            /crow
              /index.js # symlink to textsurf+crow@1.0.23/node_modules/textsurf/crow/base.js
```
