...
```
https://base.link/@wavebond/base/head/deck.link
https://base.link/@wavebond/base/1.2.3/deck.link
```
...
```
deck.base.link/@wavebond/base/1.2.3/base.tar.gz
deck.base.link/@wavebond/base/1.2.3/base.link
```
...
reaching out to support at meet@wave.bond.
...
```
https://base.link/@wavebond/base/1.2.3
```
...
```
base.link/@wavebond/:deck/code/:file+
base.link/@wavebond/buck-1212 (4 letter word followed by numbers)
base.link/@wavebond/buck-1212/mark/:mark/code/:file+ (just the code)
base.link/@wavebond/buck-1212/mark/:mark/hint/:file+/task/create-something
```
...
make.base.link/@wavebond/buck-1234
  Shows the rendering
make.base.link/@wavebond/buck-1234/hint/:file+
make.base.link/@wavebond/buck-1234/code/:file+
make.base.link
  Try and share code
...
- loading from ./code loads ./link/wavebond/crow
- loading from ./link/wavebond/crow loads from
  - /link/.tree/wavebond/crow/1.0.23
- that gets compiled into
  - /link/.work/node_modules/wavebond/crow/index.js
- and that is actually a symlink to
  - /link/.work/node_modules/.tree/wavebond+crow@1.0.23/node_modules/wavebond/crow/index.js
              ...
              /node_modules
                /@wavebond
                  /crow
                    ...
                    /index.js.map
                      => ../../../../../../../tree/wavebond/crow/1.0.23
                  /wolf
                    /index.js
          /wavebond
            /crow
              /index.js # symlink to wavebond+crow@1.0.23/node_modules/wavebond/crow/base.js
```
